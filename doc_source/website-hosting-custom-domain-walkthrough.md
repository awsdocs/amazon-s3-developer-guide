...
### Step 2\.2: Configure Your Root Domain Bucket for Website Hosting<a name="root-domain-walkthrough-configure-bucket-aswebsite"></a>
...
In the next step, you configure your subdomain \(`example.com`\) to redirect requests to your domain \(`www.example.com`\)\. 

### Step 2\.3: Configure Your Subdomain Bucket for Website Redirect<a name="root-domain-walkthrough-configure-redirect"></a>
