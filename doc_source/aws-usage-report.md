...
+ **UsageType** – One of the following values:
  ...
  + A code that identifies early deletions from INTELLIGENT\_TIERING, STANDARD\_IA, ONEZONE\_IA, GLACIER, or DEEP ARCHIVE storage
...
+ **UsageValue** – One of the following volume values:
  ...
  + The amount of data associated with restorations from DEEP ARCHIVE, GLACIER, STANDARD\_IA, or ONEZONE\_IA storage, in bytes
