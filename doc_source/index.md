...
+ [Protecting Data in Amazon S3](DataDurability.md)
   + [Protecting Data Using Encryption](UsingEncryption.md)
      ...
      + [Protecting Data Using Client-Side Encryption](UsingClientSideEncryption.md)
         + [Example: Client-Side Encryption (Option 1: Using an AWS KMS–Managed Customer Master Key (AWS SDK for Java))](client-side-using-kms-java.md)
         + [Examples: Client-Side Encryption (Option 2: Using a Client-Side Master Key (AWS SDK for Java))](UsingClientSideEncryptionUpload.md)
...
+ [Cross-Region Replication (CRR)](crr.md)
   ...
   + [Additional Cross-Region Replication Configurations](crr-additional-configs.md)
   ...
   + [Cross-Region Replication Examples](crr-example-walkthroughs.md)
...
+ [Using Amazon DevPay with Amazon S3](UsingDevPay.md)
...
+ [Server Access Logging](ServerLogs.md)
