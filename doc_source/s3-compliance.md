...
+ [Amazon S3 Object Lock](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html) can help you meet technical requirements of financial services regulators \(such as the SEC, FINRA, and CFTC\) that require write once, read many \(WORM\) data storage for certain types of books and records information\. 
