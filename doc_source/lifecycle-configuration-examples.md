...
When an object is eligible for both a GLACIER and STANDARD\_IA transition, Amazon S3 chooses the GLACIER transition\.
...
In this example, you leverage lifecycle configuration to tier down the storage class of objects over their lifetime\. This tiering down can help reduce storage costs\. For more information about pricing, see [Amazon S3 Pricing](https://aws.amazon.com/s3/pricing/)\.
