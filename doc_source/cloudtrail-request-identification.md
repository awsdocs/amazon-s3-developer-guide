...
In the following Athena query, replace *<s3\_cloudtrail\_events\_db\.cloudtrail\_myawsexamplebucket\_table>* with your Athena details and increase or remove the limit as needed\.   
